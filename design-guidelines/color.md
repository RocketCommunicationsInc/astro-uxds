...
| ![Primary Lighten Step 3](/img/swatches/primary__tint-60.svg) | +3   | `#98bdd3` | `152, 189, 211` | `--colorPrimarytint-60`  |
| ![Primary Lighten Step 2](/img/swatches/primary__tint-40.svg) | +2   | `#649cbd` | `100, 156, 189` | `--colorPrimarytint-40`  |
| ![Primary Lighten Step 1](/img/swatches/primary__tint-20.svg) | +1   | `#2f7aa7` | `47, 122, 167`  | `--colorPrimarytint-20`  |
| ![Primary Base Color](/img/swatches/primary.svg)              | Base | `#005a8f` | `0, 90, 143`    | `--colorPrimary`         |
| ![Primary Darken Step 1](/img/swatches/primary__shade-20.svg) | -1   | `#004872` | `0, 72, 114`    | `--colorPrimaryshade-20` |
| ![Primary Darken Step 2](/img/swatches/primary__shade-40.svg) | -2   | `#003655` | `0, 54, 85`     | `--colorPrimaryshade-40` |
| ![Primary Darken Step 3](/img/swatches/primary__shade-60.svg) | -3   | `#002439` | `0, 36, 57`     | `--colorPrimaryshade-60` |
| ![Primary Darken Step 4](/img/swatches/primary__shade-80.svg) | -4   | `#00121c` | `0, 18, 28`     | `--colorPrimaryshade-80` |
...
| ![Secondary Lighten Step 3](/img/swatches/secondary__tint-60.svg) | +3   | `#b7dcff` | `183, 220, 255` | `--colorSecondarytint-60`  |
| ![Secondary Lighten Step 2](/img/swatches/secondary__tint-40.svg) | +2   | `#92cbff` | `146, 203, 255` | `--colorSecondarytint-40`  |
| ![Secondary Lighten Step 1](/img/swatches/secondary__tint-20.svg) | +1   | `#6ebaff` | `110, 186, 255` | `--colorSecondarytint-20`  |
| ![Secondary Base Color](/img/swatches/secondary.svg)              | Base | `#4dacff` | `77, 172, 255`  | `--colorSecondary`         |
| ![Secondary Darken Step 1](/img/swatches/secondary__shade-20.svg) | -1   | `#3a87cf` | `58, 135, 207`  | `--colorSecondaryshade-20` |
| ![Secondary Darken Step 2](/img/swatches/secondary__shade-40.svg) | -2   | `#2b659b` | `43, 101, 155`  | `--colorSecondaryshade-40` |
| ![Secondary Darken Step 3](/img/swatches/secondary__shade-60.svg) | -3   | `#1d4367` | `29, 67, 103`   | `--colorSecondaryshade-60` |
| ![Secondary Darken Step 4](/img/swatches/secondary__shade-80.svg) | -4   | `#0e2234` | `14, 34, 52`    | `--colorSecondaryshade-80` |
...
| ![Tertiary Lighten Step 3](/img/swatches/tertiary__tint-60.svg) | +3   | `#a9b2bc` | `169, 178, 188` | `--colorTertiarytint-60`  |
| ![Tertiary Lighten Step 2](/img/swatches/tertiary__tint-40.svg) | +2   | `#7e8c9b` | `126, 140, 155` | `--colorTertiarytint-40`  |
| ![Tertiary Lighten Step 1](/img/swatches/tertiary__tint-20.svg) | +1   | `#52667a` | `82, 102, 122`  | `--colorTertiarytint-20`  |
| ![Tertiary Base Color](/img/swatches/tertiary.svg)              | Base | `#274059` | `39, 64, 89`    | `--colorTertiary`         |
| ![Tertiary Darken Step 1](/img/swatches/tertiary__shade-20.svg) | -1   | `#1f3347` | `31, 51, 71`    | `--colorTertiaryshade-20` |
| ![Tertiary Darken Step 2](/img/swatches/tertiary__shade-40.svg) | -2   | `#172635` | `36, 38, 53`    | `--colorTertiaryshade-40` |
| ![Tertiary Darken Step 3](/img/swatches/tertiary__shade-60.svg) | -3   | `#101923` | `16, 25, 35`    | `--colorTertiaryshade-60` |
| ![Tertiary Darken Step 4](/img/swatches/tertiary__shade-80.svg) | -4   | `#080c11` | `8, 12, 17`     | `--colorTertiaryshade-80` |
...
| ![Quaternary Lighten Step 3](/img/swatches/quaternary__tint-60.svg) | +3   | `#eaeef4` | `234, 238, 244` | `--colorQuaternarytint-60`  |
| ![Quaternary Lighten Step 2](/img/swatches/quaternary__tint-40.svg) | +2   | `#e1e6ef` | `225, 230, 239` | `--colorQuaternarytint-40`  |
| ![Quaternary Lighten Step 1](/img/swatches/quaternary__tint-20.svg) | +1   | `#d7dee9` | `215, 222, 233` | `--colorQuaternarytint-20`  |
| ![Quaternary Base Color](/img/swatches/quaternary.svg)              | Base | `#ced6e4` | `206, 214, 228` | `--colorQuaternary`         |
| ![Quaternary Darken Step 1](/img/swatches/quaternary__shade-20.svg) | -1   | `#a4abb6` | `164, 171, 182` | `--colorQuaternaryshade-20` |
| ![Quaternary Darken Step 2](/img/swatches/quaternary__shade-40.svg) | -2   | `#7b8089` | `123, 128, 137` | `--colorQuaternaryshade-40` |
| ![Quaternary Darken Step 3](/img/swatches/quaternary__shade-60.svg) | -3   | `#51555b` | `81, 85, 91`    | `--colorQuaternaryshade-60` |
| ![Quaternary Darken Step 4](/img/swatches/quaternary__shade-80.svg) | -4   | `#292a2d` | `41, 42, 45`    | `--colorQuaternaryshade-80` |
...
| ![Tag1 Darken Step 1](/img/swatches/tag-1__shade-20.svg) | -1   | `#a4abb6` | `164, 171, 182` | `--colorTag1shade-20` |
| ![Tag1 Darken Step 2](/img/swatches/tag-1__shade-40.svg) | -2   | `#7b8089` | `123, 128, 137` | `--colorTag1shade-40` |
| ![Tag1 Darken Step 3](/img/swatches/tag-1__shade-60.svg) | -3   | `#51555b` | `81, 85, 91`    | `--colorTag1shade-60` |
| ![Tag1 Darken Step 4](/img/swatches/tag-1__shade-80.svg) | -4   | `#292a2d` | `41, 42, 45`    | `--colorTag1shade-80` |
...
| ![Tag2 Lighten Step 3](/img/swatches/tag-2__tint-60.svg) | +3   | `#c9c5ed` | `201, 197, 237` | `--colorTag2tint-60`  |
| ![Tag2 Lighten Step 2](/img/swatches/tag-2__tint-40.svg) | +2   | `#aea8e5` | `174, 168, 229` | `--colorTag2tint-40`  |
| ![Tag2 Lighten Step 1](/img/swatches/tag-2__tint-20.svg) | +1   | `#938bdb` | `147, 139, 219` | `--colorTag2tint-20`  |
| ![Tag2 Base Color](/img/swatches/tag-2.svg)              | Base | `#786dd3` | `120, 109, 211` | `--colorTag2`         |
| ![Tag2 Darken Step 1](/img/swatches/tag-2__shade-20.svg) | -1   | `#6058a8` | `96, 88, 168`   | `--colorTag2shade-20` |
| ![Tag2 Darken Step 2](/img/swatches/tag-2__shade-40.svg) | -2   | `#48417f` | `72, 65, 127`   | `--colorTag2shade-40` |
| ![Tag2 Darken Step 3](/img/swatches/tag-2__shade-60.svg) | -3   | `#302c54` | `48, 44, 84`    | `--colorTag2shade-60` |
| ![Tag2 Darken Step 4](/img/swatches/tag-2__shade-80.svg) | -4   | `#18152b` | `24, 21, 43`    | `--colorTag2shade-80` |
...
| ![Tag3 Lighten Step 3](/img/swatches/tag-3__tint-60.svg) | +3   | `#da9ce7` | `218, 156, 231` | `--colorTag3tint-60`  |
| ![Tag3 Lighten Step 2](/img/swatches/tag-3__tint-40.svg) | +2   | `#c76ada` | `199, 106, 218` | `--colorTag3tint-40`  |
| ![Tag3 Lighten Step 1](/img/swatches/tag-3__tint-20.svg) | +1   | `#b534ce` | `181, 52, 206`  | `--colorTag3tint-20`  |
...
| ![Tag4 Lighten Step 3](/img/swatches/tag-4__tint-60.svg) | +3   | `#f0baa3` | `240, 186, 163` | `--colorTag4tint-60`  |
| ![Tag4 Lighten Step 2](/img/swatches/tag-4__tint-40.svg) | +2   | `#ea9875` | `234, 152, 117` | `--colorTag4tint-40`  |
| ![Tag4 Lighten Step 1](/img/swatches/tag-4__tint-20.svg) | +1   | `#e27545` | `226, 117, 69`  | `--colorTag4tint-20`  |
