...
<div markdown="1">
	...
	<a href="#" class="lightbox" id="demo" markdown="1">
		...
		poster="/img/service-specific-ux-design/grm-schedule-modify-contact.gif">
			<source src="https://com.rocketcom.astrouxds.s3.us-west-2.amazonaws.com/media/grm-schedule-modify-contact.mp4" type="video/mp4" markdown="1">        
			<source src="https://com.rocketcom.astrouxds.s3.us-west-2.amazonaws.com/media/grm-schedule-modify-contact.webm" type="video/webm" markdown="1">         
		</video>
	</a>
</div>
