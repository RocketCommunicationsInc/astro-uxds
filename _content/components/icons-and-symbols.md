...
- X.X.X Monitoring Icons shall include a label and a status symbol as illustrated.<!--link to icon illustration-->
- X.X.X Monitoring Icons shall be rendered with the standard status colors.<!--link to status colors-->
