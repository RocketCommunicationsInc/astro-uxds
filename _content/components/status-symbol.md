...
- 5.16.1 Status Symbols shall always be rendered with the specified shapes<!--link to colors-->.
- 5.16.2 Status Symbols shall always be rendered with the specified colors<!--link to shapes-->.
